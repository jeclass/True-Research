...
No auth by design: the app is a read-only window over runs/ plus one launch
endpoint, intended strictly for 127.0.0.1. Binding to a non-loopback host
prints a loud warning (the UI would be open to the network with no auth).
"""
